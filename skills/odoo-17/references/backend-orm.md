...
Odoo 17.0 documents `_sql_constraints` for database constraints:
...
- OCA 17 migration notes require converting older module hook signatures to
  receive `env` where applicable.
